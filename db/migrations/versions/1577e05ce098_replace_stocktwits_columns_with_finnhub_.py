...
down_revision: str | Sequence[str] | None = "7e4d30e77675"
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("reports", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column("apewisdom_mentions", sa.Integer(), server_default="0", nullable=False)
        )
        batch_op.add_column(
            sa.Column("alphavantage_sentiment", sa.Float(), server_default="0.0", nullable=False)
        )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("reports", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("stocktwits_bullish", sa.INTEGER(), server_default="0", nullable=False)
        )
        batch_op.add_column(
            sa.Column("stocktwits_bearish", sa.INTEGER(), server_default="0", nullable=False)
        )
