...
down_revision: Union[str, Sequence[str], None] = '22c6fafccec1'
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('reports', schema=None) as batch_op:
        batch_op.add_column(sa.Column('fraud_risk_score', sa.FLOAT(), server_default='0.0', nullable=False))
        batch_op.add_column(sa.Column('fraud_risk_level', sa.VARCHAR(length=10), server_default='LOW', nullable=False))
        batch_op.add_column(sa.Column('fraud_flags', sa.TEXT(), server_default='[]', nullable=False))
