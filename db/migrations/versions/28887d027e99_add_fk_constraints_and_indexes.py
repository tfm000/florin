...
down_revision: str | Sequence[str] | None = "77f433bbe71f"
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("news_stories", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_news_stories_fetched_at"), ["fetched_at"], unique=False
        )

    with op.batch_alter_table("portfolio_cache_meta", schema=None) as batch_op:
        batch_op.alter_column("holdings_count", existing_type=sa.INTEGER(), nullable=False)
        batch_op.alter_column("priceable_count", existing_type=sa.INTEGER(), nullable=False)
    ...
    with op.batch_alter_table("portfolio_cache_returns", schema=None) as batch_op:
        batch_op.alter_column("prorated", existing_type=sa.BOOLEAN(), nullable=False)
        batch_op.create_index(
            batch_op.f("ix_portfolio_cache_returns_portfolio_id"),
            ["portfolio_id"],
            unique=False,
        )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("portfolio_cache_returns", schema=None) as batch_op:
        ...
        batch_op.alter_column("prorated", existing_type=sa.BOOLEAN(), nullable=True)
    ...
    with op.batch_alter_table("portfolio_cache_meta", schema=None) as batch_op:
        ...
        batch_op.alter_column("priceable_count", existing_type=sa.INTEGER(), nullable=True)
        batch_op.alter_column("holdings_count", existing_type=sa.INTEGER(), nullable=True)
